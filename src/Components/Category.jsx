    ...
    <>
...

      {
        allCategories?.length>0?allCategories.map(category=>(
          <div className="border border-2 m-3 p-3" droppable="true" onDragOver={e=>dragOver(e)} onDrop={e=>videoDrop(e,category?.id)} >
        ...
        )): <p className='text-danger fw-bolder mt-3'>No Category Created</p>
      }
    </>
  )
}
